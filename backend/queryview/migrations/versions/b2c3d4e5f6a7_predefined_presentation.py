...
def upgrade() -> None:
    with op.batch_alter_table("predefined_queries", schema=None) as batch_op:
        batch_op.add_column(sa.Column("order_by", sqlmodel.sql.sqltypes.AutoString(), nullable=True))
        batch_op.add_column(sa.Column("fields", sqlmodel.sql.sqltypes.AutoString(), nullable=True))
